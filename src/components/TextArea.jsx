    ...
    <>
      <div className="flex flex-wrap flex-col gap-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          <button className={btnClass} onClick={uppercase}>Uppercase</button>
          <button className={btnClass} onClick={lowercase}>Lowercase</button>
          <button className={btnClass} onClick={capitalize}>Capitalize</button>
          <button className={btnClass} onClick={alternate}>AlTeRnAtE</button>
          <button className={btnClass} onClick={inverse}>iNVERSE</button>
          <a
            id="dwnBtn"
            className={`${btnClass} text-center whitespace-nowrap`}
            onClick={download}
            href="#"
          >
            Download Text
