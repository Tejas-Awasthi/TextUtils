const Alert = (props) => {
	...
	return (
		<div
			role="alert"
			className={`absolute font-inter ${props.opacity === 100 ? 'opacity-100' : 'opacity-0'} transition-opacity ease-in-out duration-300 top-0 left-0 right-0 flex items-center gap-2 sm:gap-3 max-w-xl mx-3 sm:mx-auto my-4 
